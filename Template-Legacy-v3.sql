...
-- Listage de la structure de la base pour esxlegacy_7f7936
CREATE DATABASE IF NOT EXISTS `esxlegacy_7f7936` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci */;
USE `esxlegacy_7f7936`;

-- Listage de la structure de table esxlegacy_7f7936. addon_account
...
-- Listage des données de la table esxlegacy_7f7936.addon_account : ~8 rows (environ)
...
-- Listage de la structure de table esxlegacy_7f7936. addon_account_data
...
-- Listage des données de la table esxlegacy_7f7936.addon_account_data : ~6 rows (environ)
...
-- Listage de la structure de table esxlegacy_7f7936. addon_inventory
...
-- Listage des données de la table esxlegacy_7f7936.addon_inventory : ~5 rows (environ)
...
-- Listage de la structure de table esxlegacy_7f7936. addon_inventory_items
...
-- Listage des données de la table esxlegacy_7f7936.addon_inventory_items : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_7f7936. banking
...
-- Listage des données de la table esxlegacy_7f7936.banking : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_7f7936. billing
...
-- Listage des données de la table esxlegacy_7f7936.billing : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_7f7936. cardealer_vehicles
...
-- Listage des données de la table esxlegacy_7f7936.cardealer_vehicles : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_7f7936. datastore
...
-- Listage des données de la table esxlegacy_7f7936.datastore : ~9 rows (environ)
...
-- Listage de la structure de table esxlegacy_7f7936. datastore_data
...
-- Listage des données de la table esxlegacy_7f7936.datastore_data : ~7 rows (environ)
...
-- Listage de la structure de table esxlegacy_7f7936. factions
...
-- Listage des données de la table esxlegacy_7f7936.factions : ~1 rows (environ)
INSERT INTO `factions` (`name`, `label`) VALUES
	('nofaction', 'Faction');

-- Listage de la structure de table esxlegacy_7f7936. faction_grades
...
-- Listage des données de la table esxlegacy_7f7936.faction_grades : ~1 rows (environ)
...
-- Listage de la structure de table esxlegacy_7f7936. fine_types
...
-- Listage des données de la table esxlegacy_7f7936.fine_types : ~52 rows (environ)
...
-- Listage de la structure de table esxlegacy_7f7936. items
...
-- Listage des données de la table esxlegacy_7f7936.items : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_7f7936. jobs
...
-- Listage des données de la table esxlegacy_7f7936.jobs : ~14 rows (environ)
...
-- Listage de la structure de table esxlegacy_7f7936. job_grades
...
-- Listage des données de la table esxlegacy_7f7936.job_grades : ~36 rows (environ)
...
-- Listage de la structure de table esxlegacy_7f7936. licenses
...
-- Listage des données de la table esxlegacy_7f7936.licenses : ~7 rows (environ)
...
-- Listage de la structure de table esxlegacy_7f7936. multicharacter_slots
...
-- Listage des données de la table esxlegacy_7f7936.multicharacter_slots : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_7f7936. owned_vehicles
...
-- Listage des données de la table esxlegacy_7f7936.owned_vehicles : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_7f7936. ox_doorlock
...
-- Listage des données de la table esxlegacy_7f7936.ox_doorlock : ~11 rows (environ)
...
-- Listage de la structure de table esxlegacy_7f7936. ox_inventory
...
-- Listage des données de la table esxlegacy_7f7936.ox_inventory : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_7f7936. rented_vehicles
...
-- Listage des données de la table esxlegacy_7f7936.rented_vehicles : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_7f7936. society_moneywash
...
-- Listage des données de la table esxlegacy_7f7936.society_moneywash : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_7f7936. users
...
-- Listage des données de la table esxlegacy_7f7936.users : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_7f7936. user_licenses
...
-- Listage des données de la table esxlegacy_7f7936.user_licenses : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_7f7936. vehicles
...
-- Listage des données de la table esxlegacy_7f7936.vehicles : ~240 rows (environ)
...
-- Listage de la structure de table esxlegacy_7f7936. vehicle_categories
...
-- Listage des données de la table esxlegacy_7f7936.vehicle_categories : ~11 rows (environ)
...
-- Listage de la structure de table esxlegacy_7f7936. vehicle_sold
...
-- Listage des données de la table esxlegacy_7f7936.vehicle_sold : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_7f7936. whitelist
CREATE TABLE IF NOT EXISTS `whitelist` (
  `identifier` varchar(46) NOT NULL,
  PRIMARY KEY (`identifier`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

-- Listage des données de la table esxlegacy_7f7936.whitelist : ~0 rows (environ)
